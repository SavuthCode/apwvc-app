            ...
            <div class="row">
                <div class="col-md-12">
                    <form id="media-form" class="media-form">
                        <input type="hidden" name="id" value="{{$lims_media_data->id}}" />
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-4">
                                        ...
                                        <div class="input-group">
                                            <input type="hidden" name="category" value="{{$lims_media_data->category_id}}">
                                            <select
                                    ...
                                    <div class="col-md-12 mb-4">
                                        ...
                                        <input type="text" name="title" value="{{$lims_media_data->title}}" placeholder="title" class="form-control">
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Description</label>
                                            <textarea name="description" class="form-control" rows="3">{{$lims_media_data->description}}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
