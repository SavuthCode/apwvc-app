        ...
        <table id="employee-table" class="table">
            ...
            <tbody>
                ...
                <tr data-id="{{$employee->id}}">
                    <td>{{$key}}</td>
                    @if($employee->image)
                    <td> <img src="{{url('/employee',$employee->image)}}" height="80" width="80">
                    </td>
                    @else
                    <td>No Image</td>
                    @endif
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                ...
                                <li>
                                    <button type="button" data-id="{{$employee->id}}" class="edit-btn btn btn-link" data-toggle="modal" data-target="#qrModal"><i class="dripicons-document-edit"></i> {{trans('file.QR')}}</button>
                                </li>
...
<div id="qrModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-body">
                <?php echo '<img style="margin-top:10px;" src="data:image/png;base64,' . DNS2D::getBarcodePNG(asset('employee/profile/').'/'.$employee->id, 'QRCODE') . '" alt="barcode"   />';?>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    $(document).on('click', '.edit-btn', function() {
        ...
        Object.keys(row).map((key) => {
            $(`#editModal input[name="${key}"]`).val( row[key] );
        });
