        ...
        <table id="category-table" class="table" style="width: 100%">
            <thead>
                <tr>
                    ...
                    <th>{{trans('file.Title Khmer')}}</th>
                    <th>{{trans('file.Title Enlish')}}</th>
          ...
          <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
            <div class="row">
                <div class="col-md-6 form-group">
                    <label>{{trans('file.title_kh')}} *</label>
                    {{Form::text('title_kh',null,array('required' => 'required', 'class' => 'form-control', 'placeholder' => 'Type category title kh...'))}}
                </div>
                <div class="col-md-6 form-group">
                    <label>{{trans('file.title_en')}} *</label>
                    {{Form::text('title_en',null,array('required' => 'required', 'class' => 'form-control', 'placeholder' => 'Type category title en...'))}}
                </div>
                <div class="col-md-6 form-group">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="row">
            ...
            <div class="col-md-6 form-group">
                <label>{{trans('file.title_kh')}} *</label>
                {{Form::text('title_kh',null, array('required' => 'required', 'class' => 'form-control'))}}
            </div>
            <div class="col-md-6 form-group">
                <label>{{trans('file.title_en')}} *</label>
                {{Form::text('title_en',null, array('required' => 'required', 'class' => 'form-control'))}}
            </div>
            <div class="col-md-6 form-group">
                <label>{{trans('file.Image')}}</label>
                <input type="file" name="image" class="form-control">
