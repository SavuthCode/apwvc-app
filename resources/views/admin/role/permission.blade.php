						        ...
						        <tr>
						            ...
						            <td class="report-permissions" colspan="5">
                                        ...
                                        <span>
						                    <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	@if(in_array("attribute", $all_permission))
                                                        <input type="checkbox" value="1" id="attribute" name="attribute" checked>
                                                    @else
                                                        <input type="checkbox" value="1" id="attribute" name="attribute">
                                                    @endif
								                    <label for="attribute" class="padding05">{{trans('file.Attribute')}} &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
						            </td>
