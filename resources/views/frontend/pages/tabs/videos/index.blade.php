<div id="video" class="container fade tab-pane" style="margin-top: 15px;">
    ...
    <div class="col-6 col-sm-6 col6new">
      <div class="image-book">
        ...
        <div class="icon-video">
          <img src="{{asset('frontend/images/book/icon-video.png')}}" />
        </div>
  ...
  <div class="row"  style="margin-top:15px;">
    ...
    <div class="image-book">
      ...
      <div class="book-text" style="padding:5px;">
        <p class="card-title"><a href="" style="color:red">សកម្មភាពមនុស្សធម៌របស់ថ្នាក់ដឹងនាំសមាគមនពេល</a></p>
        <h5 class="card-text">Ven sokvuth</h5>
      </div>
    </div>
    <div class="col-6 col-sm-6 col6new1">
  ...
  <div class="row"  style="margin-top:15px;">
    ...
    <div class="col-6 col-sm-6 col6new1">
      ...
      <div class="book-text" style="padding:5px;">
        <p class="card-title"><a href="" style="color:red">សកម្មភាពមនុស្សធម៌របស់ថ្នាក់ដឹកនាំសមាគមនាពេល</a></p>
        <h5 class="card-text">Ven sokvuth</h5>
      </div>
    </div>
  </div>
  <br>
  <center><button class="btn btn-primary">Read more...</button></center>
</div>